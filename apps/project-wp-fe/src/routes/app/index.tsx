...
import { Megaphone, MessageSquare, Users, Workflow } from "lucide-react";
...
function DashboardPage() {
	...
	const { hasOrganization, hasConnectedWABA, activeOrganization } =
			...
			<div className="grid gap-4 md:grid-cols-2">
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Your latest customer conversations
						</CardDescription>
					</CardHeader>
					<CardContent>
						<p className="text-sm text-muted-foreground">
							No conversations yet. Messages will appear here when customers
							reach out.
						</p>
					</CardContent>
				</Card>
